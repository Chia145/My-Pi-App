...
export default class Bday extends React.Component {
  constructor() {
    super();
    this.state = {
      d: '',
    ...
    return (
      ...
      <View style={{ flex:1 }}>
        ...
        <View style={styles.container}>
          ...
          <Text style={styles.paragraph}>Enter your Birthday</Text>
          <Input 
          ...
          <Input
            style={styles.formTextInput}
            containerStyle={{ marginTop: 30, color:'white' }}
            label={''}
            inputStyle = {{color: 'white'}}
